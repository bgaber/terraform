...
variable "compartment_ocid" {
  description = "QC_APP Compartment OCID"
  default     = "ocid1.compartment.oc1..aaaaaaaafyzvxc2t3w27kj7rtia7zdebknxkqeq6onv24uyo3ux3emkzvhgq"
  type        = string
}
...
variable "subnet_ocid" {
  description = "NONPROD_APP_PVT_SN Subnet OCID"
  default     = "ocid1.subnet.oc1.iad.aaaaaaaavvdnhdxyagsp5ocf5khnffh47tooudj6pqqzmkxfpruizjtmcoua"
  type        = string
}

variable "server_name" {
  description = "Server Name"
  default     = "qocioraper02"
  type        = string
}
...
variable "ssh_public_key" {
  ...
  default     = "/home/awsadmin/bg216063/oci-ssh-keys/qc-ssh-key.pub"
  type        = string
}