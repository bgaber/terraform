resource "datadog_synthetics_test" "elite_test_browser" {
  ...
  request_definition {
    method = "GET"
    url    = "https://sistersofmercy-sso.app.tecsys.cloud/auth"
  }
