...
output "customers_current_password_ids" {
  value = { for key, resource in datadog_synthetics_global_variable.current_password_variable : key => resource.id }
  description = "Map of customers and their respective Current Password IDs"
}
