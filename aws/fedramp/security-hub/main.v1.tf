...
output "fedramp_tools_security_hub_arn" {
  value = module.fedramp_tools_config.aws_securityhub_account_arn
}

output "fedramp_tools_config_security_hub_id" {
  value = module.fedramp_tools_config.aws_securityhub_account_id
}