  ...
  policy = jsonencode({
    ...
    Statement: [
        ...
        },
        {
            ...
            Resource: [
              "arn:aws:logs:us-east-1:${local.account_id}:log-group:/aws/lambda/${var.lambda_name}:*",
              "arn:aws:logs:us-west-2:${local.account_id}:log-group:/aws/lambda/${var.lambda_name}:*"
            ]
        },
        {
            ...
            Resource: [
              ...
              "arn:aws:ssm:us-west-2:${local.account_id}:parameter/*"
            ]
        }
    ]
  })
