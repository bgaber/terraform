    ...
    mainSteps = [
      {
        ...
        inputs = {
          runCommand = [
            ...
            "export FALCON_APH=proxy.zone-proxy.cloud",
            "export FALCON_APP=3128",
    ...
    "mainSteps": [
        {
            ...
            "inputs": {
                ...
                "runCommand": [
                    ...
                    "& $installScriptPath -FalconCloud us-gov-1 -FalconClientId '{{ falconClientId }}' -FalconClientSecret '{{ falconClientSecret }}' -ProxyHost proxy.zone-proxy.cloud -ProxyPort 3128 --ErrorAction Stop",
                    "",
