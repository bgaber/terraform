...
module "fedramp_network_prd_eb_lambda" {
  ...
  linux_ssm_document_name = module.fedramp_network_prd_ssm.linux_ssm_document_id
  windows_ssm_document_name = module.fedramp_network_prd_ssm.windows_ssm_document_id
}

output "fedramp_network_prd_linux_ssm_document_arn" {
  value = module.fedramp_network_prd_ssm.linux_ssm_document_arn
}

output "fedramp_network_prd_windows_ssm_document_arn" {
  value = module.fedramp_network_prd_ssm.windows_ssm_document_arn
}
