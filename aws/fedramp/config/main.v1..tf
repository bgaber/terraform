...
output "fedramp_tools_config_recorder_id" {
  value = module.fedramp_tools_config.aws_config_configuration_recorder_id
}

output "fedramp_tools_config_channel_id" {
  value = module.fedramp_tools_config.aws_config_delivery_channel_id
}