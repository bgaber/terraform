...
#   lambda_role_arn    = "arn:aws:iam::980921753767:role/FedRAMPLambdaIAMRole" ## ARN from FedRAMP Security account
...
module "fedramp_agencysim_npri_iam_role" {
  source = "./modules/lambda-iam-assume-role"
  lambda_role_arn    = "arn:aws:iam::980921753767:role/FedRAMPLambdaIAMRole" ## ARN from FedRAMP Security account
  lambda_assume_role = "FedRAMPSSMIAMRole"
  lambda_policy      = "FedRAMPSSMIAMPolicy"
  providers = {
    aws = aws.fedramp_agencysim_npri
  }
}
