...
output "fedramp_edge_nw_npr_iam_access_analyzer_arn" {
  value = module.fedramp_edge_nw_npr_config.aws_iam_access_analyzer_arn
}

output "fedramp_edge_nw_npr_iam_access_analyzer_id" {
  value = module.fedramp_edge_nw_npr_config.aws_iam_access_analyzer_id
}
...
output "fedramp_edge_nw_prd_iam_access_analyzer_arn" {
  value = module.fedramp_edge_nw_prd_config.aws_iam_access_analyzer_arn
}

output "fedramp_edge_nw_prd_config_iam_access_analyzer_id" {
  value = module.fedramp_edge_nw_prd_config.aws_iam_access_analyzer_id
}
...
output "fedramp_tools_iam_access_analyzer_arn" {
  value = module.fedramp_tools_config.aws_iam_access_analyzer_arn
}

output "fedramp_tools_config_iam_access_analyzer_id" {
  value = module.fedramp_tools_config.aws_iam_access_analyzer_id
}