...
module "fedramp_network_access_analyzer" {
  source = "./modules/iam-access-analyzer"
  providers = {
...
output "fedramp_network_iam_access_analyzer_arn" {
  value = module.fedramp_network_access_analyzer.aws_iam_access_analyzer_arn
}

output "fedramp_network_iam_access_analyzer_id" {
  value = module.fedramp_network_access_analyzer.aws_iam_access_analyzer_id
}
