...
resource "aws_lb_listener" "fargate_https" {
  ...
  certificate_arn   = "arn:aws:acm:us-east-1:122639376858:certificate/747299d6-2b6e-44ee-b882-4d943f608bbf"
...
resource "aws_ecs_service" "my_fargate_service_f490_c034" {
  ...
  task_definition = "arn:aws:ecs:us-east-1:122639376858:task-definition/connect-task-prod:101"
}
