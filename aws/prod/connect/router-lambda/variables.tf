...
variable "lex_bot_names_old" {
  type    = list(string)
  default = ["camh", "cke", "collegium", "compucom", "covetrus", "democonnect", "epicbrokers", "firstenergy", "firstgroup", "generali", "helpathome", "holcim", "hub", "iiroc", "mfda", "mossadams", "othersgeneric", "pmpediatrics", "reuse", "signet", "sonic", "transdev", "usg", "vancouverinternationalairport", "veolia", "vestis"]
}
...
variable "lex_bot_alias_arn" {
  ...
  default     = "arn:aws:lex:us-east-1:122639376858:bot-alias/YZQMY8FT5Q/TSTALIASID"
  type        = string
}