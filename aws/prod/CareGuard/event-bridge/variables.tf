  ...
  default = [
    {
      ...
      lambda_arn        = "arn:aws:lambda:us-east-1:122639376858:function:careguard-sn-device-update"
    },
    {
      sched_name        = "careguard-sn-location-update-rule-daily",
      sched_description = "Daily Careguard SN Location Update",
      lambda_arn        = "arn:aws:lambda:us-east-1:122639376858:function:careguard-sn-location-update"
    },
    {
      sched_name        = "careguard-sn-ticket-update-rule-daily",
      sched_description = "Daily Careguard SN Ticket Update",
      lambda_arn        = "arn:aws:lambda:us-east-1:122639376858:function:careguard-sn-ticket-update"
    }
  ]
}